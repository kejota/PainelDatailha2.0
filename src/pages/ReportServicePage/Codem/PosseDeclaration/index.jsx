...
import Posse from '.././../Components/Declarations/Posse'
                    ...
                    <div id="centralContainer">
                        {this.state.search.map((e, indexResearch) =>
                            <>
                                ...
                                <Posse
                                nomeDeclarante={this.state.search[indexResearch].questions[1].query.response.res}
                                estadoCivil={this.state.search[indexResearch].questions[35].query.response.res}
                                profissao={this.state.search[indexResearch].questions[10].query.response.res}
