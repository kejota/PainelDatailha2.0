...
import Autonomos from '.././../Components/Declarations/TrabalhadorAutonomo'
...
class AutonomosDeclaration extends Component {
    constructor() {
        super()
        this.state = {
            title: "",
                    ...
                    <div id="centralContainer">
                        {this.state.search.map((e, indexResearch) =>
                            <>
                                ...
                                />
                                <Autonomos
                                    nome={this.state.search[indexResearch].questions[1].query.response.res}
                                    cpf={this.state.search[indexResearch].questions[2].query.response.res}
                                    rua={this.state.search[indexResearch].questions[29].query.response.res}
                                    ...
                                    rendaMensal={this.state.search[indexResearch].questions[16].query.response.res}
                                    data={this.state.dateResponse}

                                    signatureImg={this.state.search[indexResearch].questions[63].query.response.res}
                                />
...
export default AutonomosDeclaration